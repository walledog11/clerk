...
vi.mock('bullmq', () => ({
    Worker: vi.fn().mockImplementation(function (queueName, handler) {
...
function makeIgDmJob(organizationId, senderId = 'ig_sender_001') {
    return {
        id: 'job-ig-test',
        data: {
            platform: 'ig_dm',
...
function makeShopifyJob(organizationId, topic, customer, orderOverrides = {}) {
    return {
        id: 'job-shopify-test',
        data: {
            platform: 'shopify',
